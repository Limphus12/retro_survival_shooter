...
namespace com.limphus.retro_survival_shooter
{
    ...
    {
        [Header("Attributes - AI Placement")]
        [SerializeField] private GameObject[] AI;

        [SerializeField] private float placementChance;

        [Header("Attributes - Grid Size")]
        [Space]
        ...
        public void Clear() => ClearAssets();
        public void EditorClear() => EditorClearAssets();

        private void GenerateAssets()
        {
            AssetLoop(gridSize, gridMultiplier, gridOffset, AI, placementChance, 0f);
        }
